 ...
 * <ul>
 *   <li>{@link kr.or.eclipse.addressbook.impl.GroupImpl#getEntries <em>Entries</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GroupImpl extends EntryImpl implements Group {
	/**
	...
	public EList<Entry> getEntries() {
		if (entries == null) {
			entries = new EObjectContainmentWithInverseEList<Entry>(Entry.class, this, AddressbookPackage.GROUP__ENTRIES, AddressbookPackage.ENTRY__PARENT);
		}
		return entries;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AddressbookPackage.GROUP__ENTRIES:
